	...
	<body class="homepage">
			...
			<!-- 			<li>
						...
						<li class="purchase-btn">
							<form method="get" action="index.html">
								<button type="submit" class="btn btn-default"><a href="contact.html" title="Contact us">Contact us</a></button>
							</form>
						</li>
					</ul>
				</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4 col3">
					<a href="services-single.html" title="Puppy play" class="roundal" id="adoption"></a>
					<h3>Puppy play</h3>
					<p>Eodem modo typi, qui nunc nobis videntur parum clari, fiant sollemnes in futurum. Humanitatis per seacula quarta decima et quinta decima.</p>
					<form method="get" action="services-single.html">
						<button type="submit" class="btn btn-default btn-green">Learn more</button>
				...
				<div class="row">
					<div class="col-md-12 centered">
						...
						<div id="home_testimonial" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner">
								<div class="item active">
									<blockquote>"Picked up my 2 bull terriers yesyerday after their week at Whitebridge. The guys are great and so love dogs which for us means everything. Both, especially Millie, are knackered which means they have had a blast. I love not having to worry about them when we are away but the guys still humour me and post pictures on Facebook. Thank-you "</blockquote>
									<cite>Tracy Freame</cite>
								</div>
								<div class="item">
									<blockquote>"Paul, Becky, Jacqui and all the staff are so friendly and Duke loves it there. He rarely eats when I'm not around and is normally in a hurry to jump in the car to come home. But here is a totally different story, it's becoming his second home with doggy day care and is so much more confident in himself and that's down to the guys here who totally care and love dogs - thank you so much everyone for helping duke get back to his old self, happy and full of himself, will never go anywhere else"</blockquote>
									<cite>Julie</cite>
								</div>
								<div class="item">
									<blockquote>"We live in Yorkshire and come down to see friends and family. Our Neo (who is a 50kg giant rottweiler) loves his holiday here! The only problem we had was trying to get him in the car to come home. He definitely wanted to stay!"</blockquote>
									<cite>Nyx</cite>
								</div>
								<div class="item">
									<blockquote>"Paul, Becky and Jacqui are fabulous, very kind and caring and went out their way to reply to the dozen or so emails I sent as our dog can't be a bit of a handful as she doesn't like strangers. They even sent pictures. All the staff are great at what they do and I shall definitely be using their services again. "</blockquote>
									<cite>Beverley Copping</cite>
								</div>
							</div>
						</div>
						<!-- Slider end -->
...
<!-- 					<div class="col-md-4">
					...
					<div class="col-md-6 contact-info">
						...
						<p class="c-details">
							<span>Mail</span> <a href="#" title="">whitebridgeboardingkennels@gmail.com</a><br >
							<span>Tel</span> 01769 561094
						</p>
					</div>
				</div>
				<div class="row">
